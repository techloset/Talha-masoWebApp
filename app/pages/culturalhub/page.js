...
const page = () => {
  return (
    <div className=" absolute  -z-10 top-12 md:top-0 px-[20px] pb-[45px]  md:px-[90px] md:py-[90px] ">
      <p className="text-[25.6px] py-[15px ] md:text-[44px] md:h-[82px]  md:px-[15px]">
        Cultural Hub{" "}
      </p>
      ...
      <div className="md:grid md:grid-cols-2">
        <div className="md:grid md:col-span-1 md:px-[15px]">
          ...
          <p className="text-[12.8px] text-[#6E6E6E] my-[18px] md:text-[15px] md:my-[21px] ">
          ...
          <p className="text-[12.8px] text-[#6E6E6E] my-[18px] md:my-0 md:mb-[21px]">
          ...
          <p className="text-[12.8px] text-[#6E6E6E] mt-[18px] md:mt-0 md:mb-[21px]">
      ...
      <div className="md:grid md:grid-cols-2 ">
        ...
        <div className="md:grid md:col-span-1 md:px-[15px]">
          <p className="text-[22px] md:text-[26px]">
            {" "}
            The Gallery at Mason Studio
          </p>
          <p className="text-[12px] py-[18px] md:py-0 text-[#6E6E6E]  md:text-[15px] md:my-[21px] ">
          ...
          <p className="text-[12px] py-[18px] md:py-0 text-[#6E6E6E]  md:my-0 md:mb-[21px]">
            Everyone is welcome to the Gallery to experience how culture,
            business and creativity can come together to make better.
          </p>
          <p className="text-[12px] py-[18px] md:py-0 text-[#6E6E6E]  md:mt-0 md:mb-[21px]  ">
