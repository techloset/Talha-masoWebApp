...
const page = () => {
  return (
    <div className=" absolute  -z-10 top-12 px-[20px] pb-[45px]  md:top-0 md:p-[90px] ">
      <p className="text-[25.6px]  h-[82.79px] md:text-[44px]  md:px-[15px]">
        About
      </p>
      ...
      <div className="md:grid md:grid-cols-2   ">
        <div className="md:grid md:col-span-1 md:px-[15px]  md:font-[300]">
          ...
          <p className="text-[12.8px] md:text-[15px] text-[#6E6E6E] my-[18px] md:my-[21px]">
            At Mason Studio, we design thoughtfully and care deeply, guided by
            our innate need to make better. This is not just to affect the world
            but to understand both the opportunities we have and the
            possibilities we can create to bring real value to society, an
            experience or a personal moment in a meaningful way.{" "}
          </p>
          <p className="text-[12.8px] md:text-[15px]  text-[#6E6E6E] my-[18px] md:my-0 md:mb-[21px]">
            Our team is diverse academically, culturally and personally and we
            bring our whole selves to each of our projects to express the
            richness of humanity and enhance the value of the design experience.
            While all our designers are trained in interior design, we have
            expertise in architecture, furniture design, human sciences, art
            consultancy, art history, fine arts, textile design, graphic design,
            business, finance and economics.{" "}
          </p>
          <p className="text-[12.8px] md:text-[15px]  text-[#6E6E6E] my-[18px] md:my-0 md:mb-[21px]">
            We have had the pleasure of partnering with worldwide clients to
            co-create unconventional and successful solutions.{" "}
          </p>
        ...
        <div className="md:hidden mt-[30px] mb-[20px] border-b-[1px] border-gray-300 ">
         ...
         <div className="md:px-[15px]  md:mb-5 md:border-b md:border-gray-300">
          ...
          <p className=" text-[12px] mt-[12.8px] mb-[18.8px] md:text-[15px]  text-[#6E6E6E] ">
            ...
            of Mason Studio s innovative research-based process. She ensures
            design decisions are thoughtfully evaluated based on their potential
            contribution to the end user, design process, and clients goals. Her
            collaborative approach ensures a broad-based perspective, leveraging
            the skills and knowledge of the entire team to fully inform each
            design project. As a respected leader in the Canadian design
            community, Ashley has also been featured in international design
            media and regularly participates in thought leadership at notable
          ...
          <p className="md:mb-6 text-[12px] md:text-[15px] mt-[12.8px] text-[#6E6E6E]  ">
            ...
            first observes how people experience and react to the built
            environment to create a rational and intuitive design solution. Of
            particular interest to Stanleys practice is the science of light and
            the physiological and psychological response people have to light.As
            an advocate for Canadian design, Stanley has been published widely
            and has participated as a keynote speaker at leading design
      ...
      <div className="md:grid md:grid-cols-2 ">
        ...
        <div className="md:hidden my-[20px] border-b-[1px] border-gray-300 ">
          {" "}
        </div>
        ...
        <div className="md:grid md:col-span-1  md:px-[15px]">
          ...
          <ul>
            ...
            <li className="text-[12px] md:text-[15px] text-[#6E6E6E]">
              ...
              Mason Studios New Work - Runxi Residences
            </li>
            <li className="text-[12px] text-[#6E6E6E]">
              <span className="text-[#000000]">2021 - Interior Design /</span>{" "}
              Big Ideas - Mobile Retail
            </li>
            <li className="text-[12px] text-[#6E6E6E]">
            ...
            <li className="text-[12px] md:text-[15px] text-[#6E6E6E]">
              ...
              Best of Canada: Retail, Picnic Food
            </li>
          </ul>
        </div>
      </div>
