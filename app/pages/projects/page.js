...
const page = () => {
  ...
  return (
    <div className=''>
      ...
      {/* <div className='hidden  md:grid md:grid-cols-12  bg-orange-500'>



        <div className=' md:col-span-8 md:pl-[90px] md:pt-[90px]  md:pr-[30px]  md:main'>
          <p className='md:pb-[30px] md:text-[44px]'>Projects</p>
          <div>
            <table className=' md:text-[15px] '>
...
<div className=' md:col-span-8  bg-orange-500 md:main   '>
  <p className='md:pb-[30px] md:text-[44px]'>Projects</p>
  <div>
    <table className=' md:text-[15px] '>
